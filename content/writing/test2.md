...
- 从 GitHub 安装
    - [Release](https://github.com/magicdawn/bilibili-app-recommend/raw/release/bilibili-app-recommend.user.js) (
      GreasyFork 版本自动同步源)
...
- 方案1: 使用 [Bilibili-Evolved](https://github.com/the1812/Bilibili-Evolved) 提供的深色模式切换, 这个脚本适配了 Evolved
  的夜间模式.
- 方案2: 使用 [Dark Reader](https://chromewebstore.google.com/detail/dark-reader/eimadpbcbfnmbkopoojfekhnkhdbieeh) 扩展:
  无适配, 但基本可用.
...
- 会使用 main 分支代码自动构建
- 构建结果:
  即上面提到的 [开发版](https://github.com/magicdawn/bilibili-app-recommend/raw/release-nightly/bilibili-app-recommend.mini.user.js)
